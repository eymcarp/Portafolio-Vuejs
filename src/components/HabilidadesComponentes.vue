...
const habilidades = ref([
    ...
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            ...
            { id: 5, nombre: 'Bootstrap', nivel: 'Basico', icono: img10 }
        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            { id: 1, nombre: 'Git', nivel: 'Avanzado', icono: img11 },
            { id: 2, nombre: 'Docker', nivel: 'Basico', icono: img12 },
            { id: 3, nombre: 'Cypress', nivel: 'Basico', icono: img13 },
...
.skills-contenedor {
    ...
    /*Fondo con gradiente*/
    background: linear-gradient(-45deg, #f3f4f5, #dd1b1b, #bbcfdf, #d48787);
